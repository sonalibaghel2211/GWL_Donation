...
type Module = typeof import("../webhooks.subscription_contracts.update.js")

type Info = GetInfo<{
  file: "routes/webhooks.subscription_contracts.update.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../webhooks.subscription_contracts.update.js");
}];
