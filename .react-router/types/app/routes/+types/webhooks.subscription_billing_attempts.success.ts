...
type Module = typeof import("../webhooks.subscription_billing_attempts.success.js")

type Info = GetInfo<{
  file: "routes/webhooks.subscription_billing_attempts.success.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../webhooks.subscription_billing_attempts.success.js");
}];
