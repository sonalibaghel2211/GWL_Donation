...
type Module = typeof import("../webhooks.subscription_billing_attempts.failure.js")

type Info = GetInfo<{
  file: "routes/webhooks.subscription_billing_attempts.failure.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../webhooks.subscription_billing_attempts.failure.js");
}];
