...
type Module = typeof import("../subscriptions.$id.js")

type Info = GetInfo<{
  file: "routes/subscriptions.$id.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../subscriptions.js");
}, {
  id: "routes/subscriptions.$id";
  module: typeof import("../subscriptions.$id.js");
}];
