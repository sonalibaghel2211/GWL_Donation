...
type Module = typeof import("../app.preset-donation_.edit.$id.js")

type Info = GetInfo<{
  file: "routes/app.preset-donation_.edit.$id.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../app.preset-donation_.edit.$id.js");
}];
