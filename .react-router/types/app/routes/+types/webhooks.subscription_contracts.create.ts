...
type Module = typeof import("../webhooks.subscription_contracts.create.js")

type Info = GetInfo<{
  file: "routes/webhooks.subscription_contracts.create.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../webhooks.subscription_contracts.create.js");
}];
