...
type Module = typeof import("../api.customer.subscription-status.js")

type Info = GetInfo<{
  file: "routes/api.customer.subscription-status.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.customer.subscription-status.js");
}];
