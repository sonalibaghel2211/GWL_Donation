...
type Module = typeof import("../app.recurring-subscriptions.js")

type Info = GetInfo<{
  file: "routes/app.recurring-subscriptions.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../app.recurring-subscriptions.js");
}];
