...
type Module = typeof import("../app.preset-donation_.delete.$id.js")

type Info = GetInfo<{
  file: "routes/app.preset-donation_.delete.$id.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../app.preset-donation_.delete.$id.js");
}];
