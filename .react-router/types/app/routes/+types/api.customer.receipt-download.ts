...
type Module = typeof import("../api.customer.receipt-download.js")

type Info = GetInfo<{
  file: "routes/api.customer.receipt-download.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.customer.receipt-download.js");
}];
