import{j as e}from"./jsx-runtime-B5AtTLU8.js";function l({title:t,description:r,themeEditorUrl:o,buttonLabel:i,previewSvg:c,instructions:a}){return e.jsxs("div",{className:"config-card",children:[e.jsx("div",{className:"config-card__header",children:e.jsxs("div",{className:"config-card__header-text",children:[e.jsx("h3",{className:"config-card__title",children:t}),e.jsx("p",{className:"config-card__description",children:r})]})}),e.jsxs("div",{className:"config-card__body",children:[e.jsx("div",{className:"config-card__action-col",children:e.jsxs("a",{href:o,target:"_blank",rel:"noopener noreferrer",className:"config-card__btn",children:[i,e.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",style:{marginLeft:6,verticalAlign:"middle"},children:[e.jsx("path",{d:"M18 13v6a2 2 0 01-2 2H5a2 2 0 01-2-2V8a2 2 0 012-2h6"}),e.jsx("polyline",{points:"15 3 21 3 21 9"}),e.jsx("line",{x1:"10",y1:"14",x2:"21",y2:"3"})]})]})}),e.jsx("div",{className:"config-card__preview",dangerouslySetInnerHTML:{__html:c}})]}),e.jsx("p",{className:"config-card__instructions",children:a.map((d,n)=>n%2===1?e.jsx("strong",{children:d},n):e.jsx("span",{children:d},n))})]})}function h({heading:t="Add App Block via Theme Customizer",subheading:r="Set up the donation widget on your store pages using the theme customizer.",blocks:o}){return e.jsxs("div",{className:"config-tab",children:[e.jsxs("div",{className:"config-tab__heading-group",children:[e.jsx("h2",{className:"config-tab__heading",children:t}),e.jsx("p",{className:"config-tab__subheading",children:r})]}),o.map(i=>e.jsx(l,{...i},i.id)),e.jsx("style",{children:`
        .config-tab {
          padding: 4px 0 24px;
          font-family: inherit;
          max-width: 900px;
...
</svg>`;export{x as C,f as P,h as a};
